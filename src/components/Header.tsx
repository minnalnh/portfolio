...
const Header = () => {
  return (
    <header className="header flex justify-center items-start w-full py-8 pb-8 header-bg">
      <div className="flex">
        {/* profilbild */}
        <img
          src={profilePic}
        ...
        <div className="header__grid-container grid grid-cols-[auto_auto_auto] grid-rows-2 gap-x-0 items-start place-items-center max-w-[600px] mx-auto mt-10">
          ...
          <img
            src={staircase}
            alt="Textdekoration"
            className="header__detail row-start-2 col-start- row-span-2 w-10 h-10 object-contain"
          />
